...
func RegisterBlocklyAutomationEndpoint(c *gin.Engine) {
	...
	c.StaticFS("/BlocklyAutomationb", http.Dir("/home/adi/go/pkg/mod/github.com/adrian-badulescu/go-blockly@v0.0.0-20220411180535-5dfd966c0cd0"))
	...
	fmt.Println(http.Dir(os.Getenv("GOPATH") + "/pkg/mod/github.com/adrian-badulescu/go-blockly@v0.0.0-20220411180535-5dfd966c0cd0"))
}
